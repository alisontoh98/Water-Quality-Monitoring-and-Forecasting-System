...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($username_err) && empty($password_err)){
        ...
        $sql = "SELECT ADMIN_ID, ADMIN_USERNAME, ADMIN_PASSWORD FROM administrator WHERE ADMIN_USERNAME = ?";
...
<center><h1>Water Quality Monitoring and Forecasting System</h1></center>
    ...
    <div class="login">
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
			...
			?>
            <p style="font-size:14px; color:#555; text-align:center"> Login as <a href="login.php">User</a>.</p>
        </form>
    </div>
</body>
</html>
