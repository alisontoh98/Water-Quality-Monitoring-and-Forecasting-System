...
<body onload=display_ct();>
	...
	<div class="title">
		<h2 class="aligncenter" style="font-size: 30px">User Account List</h2>
	</div>
<p style="text-align:right" id='ct'></p>
<br><br>
<div id="container" >
	<?php
        $res = mysqli_query($link, "SELECT * FROM fish_hatchery_staff WHERE STAFF_STATUS='Approved' ");
    ...
    ?>
        ...
        <?php
            ...
            while($row=mysqli_fetch_assoc($res)){
                ...
                <button type="submit" name="delete" onclick="return confirm('Delete this user?')" class="button2"><span style="color:white" class="fa fa-close"></span>&nbsp Delete</button>
                </form>
                </td>
                </tr>
                <?php
        ...
        if(isset($_POST['delete'])){
            ...
            mysqli_query($link,"DELETE FROM fish_hatchery_staff WHERE STAFF_ID ='$id'");
            echo "<script type='text/javascript'>alert('User Deleted!'); window.location.href = 'admin_account.php';</script>";
